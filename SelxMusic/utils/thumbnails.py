...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("SelxMusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("SelxMusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("SelxMusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("SelxMusic/assets/play_icons.png")
